    ...
    <section className="py-20 bg-gradient-section-alt">
      <div className="container mx-auto px-4">
        <h2 className="section-heading text-center mb-4">
          {t.howItWorks} <span className="gradient-text">{t.howItWorksHighlight}</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="text-xs font-mono text-muted-foreground mb-2 tracking-wider">{t.step} 0{i + 1}</div>
