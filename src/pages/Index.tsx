    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="section-heading mb-2">{t.popularCapsules}</h2>
          <p className="text-muted-foreground mb-8">{t.popularDesc}</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {popular.map((c, i) => <CapsuleCard key={c.id} capsule={c} index={i} />)}
          </div>
        </div>
      </section>
      <CategoryGrid />
      <section className="py-16 bg-gradient-section">
        <div className="container mx-auto px-4">
          <h2 className="section-heading mb-2">{t.newCapsules}</h2>
          <p className="text-muted-foreground mb-8">{t.newDesc}</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {newest.map((c, i) => <CapsuleCard key={c.id} capsule={c} index={i} />)}
          </div>
        </div>
      </section>
      <Footer />
